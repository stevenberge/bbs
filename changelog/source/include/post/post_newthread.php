...
//	showmessage($_G['forum']['pushsection']);
}
...
/////
	...
	function push_thread_local($feedSection,$feedTitle,$feedContent,$feedLink){
	...
	if($ispush){
		...
		if(push_thread_local($pushsection,$subject,messagecutstr($message,100),"http://localhost/bbs/forum.php?mod=viewthread&tid=".$tid)){
