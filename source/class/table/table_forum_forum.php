...
////////////////////////pushsection
	public function fetch_pushsection_by_fid($fid){
	  $data = DB::fetch_all("SELECT pushsection FROM ".DB::table($this->_table)." WHERE fid='$fid'");
	  if(!empty($data)) return $data[0]['pushsection'];
	  return null;
	}
