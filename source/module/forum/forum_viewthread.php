...
//echo "<hr>viewthread.php<br/>";
//echo "thread: ";print_r($_G['thread']);
//echo "<hr>";
...
//////////////////
//	echo"tid: ";	print_r($_G['tid']);echo "<br/>";
	$followlist=C::t('forum_threadfollower')->fetch_all_by_tid($_G['tid']);
...
//	echo "post: ";print_r($postarr);echo"<br/>";
