...
0
|| checktplrefresh('data/diy/./template/daren2_123//portal/index.htm', './template/daren2_123/common/header.htm', 1371480348, 'diy', './data/template/7_diy_portal_index.tpl.php', 'data/diy/./template/daren2_123/', 'portal/index')
|| checktplrefresh('data/diy/./template/daren2_123//portal/index.htm', './template/default/common/footer.htm', 1371480348, 'diy', './data/template/7_diy_portal_index.tpl.php', 'data/diy/./template/daren2_123/', 'portal/index')
|| checktplrefresh('data/diy/./template/daren2_123//portal/index.htm', './template/default/common/header_common.htm', 1371480348, 'diy', './data/template/7_diy_portal_index.tpl.php', 'data/diy/./template/daren2_123/', 'portal/index')
;
block_get('79,80,81');?>
...
<?php } ?>
<div id="wp" class="wp"  style="border: 3px solid #909498;padding:10px;background:#f0f0f0;margin-top:10px;"><?php echo adshow("subnavbanner/a_mu");?><style id="diy_style" type="text/css"></style>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framexszSU2" class="frame move-span cl frame-1-1-1"><div class="title frame-title"><span class="titletext">1-1-1框架</span></div><div id="framexszSU2_left" class="column frame-1-1-1-l"><div id="framexszSU2_left_temp" class="move-span temp"></div><?php block_display('79');?></div><div id="framexszSU2_center" class="column frame-1-1-1-c"><div id="framexszSU2_center_temp" class="move-span temp"></div><?php block_display('80');?></div><div id="framexszSU2_right" class="column frame-1-1-1-r"><div id="framexszSU2_right_temp" class="move-span temp"></div><?php block_display('81');?></div></div></div><!--[/diy]-->
</div>	</div>
