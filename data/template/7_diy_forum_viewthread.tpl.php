...
0
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/daren2_123/common/header.htm', 1371489344, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', './template/daren2_123', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/daren2_123/forum/viewthread_node.htm', 1371489344, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', './template/daren2_123', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1371489344, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', './template/daren2_123', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/footer.htm', 1371489344, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', './template/daren2_123', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/header_common.htm', 1371489344, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', './template/daren2_123', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1371489344, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', './template/daren2_123', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/seditor.htm', 1371489344, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', './template/daren2_123', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/seccheck.htm', 1371489344, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', './template/daren2_123', 'forum/viewthread')
;?>
...
<a id="diy-tg" href="javascript:openDiy();" title="´ò¿ª DIY Ãæ°å" class="y"><img src="<?php echo STATICURL;?>image/diy/panel-toggle.png" alt="DIY" /></a>
...
<a href="javascript:;" onclick="widthauto(this)"><?php if(!$_G['forum_widthauto']) { ?>ÇĞ»»µ½¿í°æ<?php } else { ?>ÇĞ»»µ½Õ­°æ<?php } ?></a>
<?php } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">ÇĞ»»·ç¸ñ</a><?php } if(CURMODULE != 'topic' && $_G['group']['allowdiy'] && !empty($_G['style']['tplfile']) || CURMODULE == 'topic' && !empty($_G['style']['tplfile']) && ($_G['group']['allowaddtopic'] && $topic['uid'] == $_G['uid'] || $_G['group']['allowmanagetopic'])) { ?>
<a id="diy-tg" href="javascript:openDiy();" title="´ò¿ª DIY Ãæ°å" class="xi1 xw1">DIY</a>
<?php } ?>
</div>
</div>
</div>
...
<span class="pipe">|</span><a href="home.php?mod=spacecp">ÉèÖÃ</a>
...
<?php if($_G['setting']['taskon'] && !empty($_G['cookie']['taskdoing_'.$_G['uid']])) { ?><span class="pipe">|</span><a href="home.php?mod=task&amp;item=doing" id="task_ntc" class="new">½øĞĞÖĞµÄÈÎÎñ</a><?php } if(($_G['group']['allowmanagearticle'] || $_G['group']['allowpostarticle'] || $_G['group']['allowdiy'] || getstatus($_G['member']['allowadmincp'], 4) || getstatus($_G['member']['allowadmincp'], 2) || getstatus($_G['member']['allowadmincp'], 3))) { ?>
...
<?php } ?>
<div id="wp" class="wp"  style="border: 3px solid #909498;padding:10px;background:#f0f0f0;margin-top:10px;"><?php echo adshow("subnavbanner/a_mu");?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<div class="z">
<a href="./" class="nvhm" title="Ê×Ò³"><?php echo $_G['setting']['bbname'];?></a><em>&raquo;</em><a href="forum.php"<?php if($_G['setting']['forumjump']) { ?> id="fjump" onmouseover="delayShow(this, 'showForummenu(<?php echo $_G['fid'];?>)');" class="showmenu" <?php } ?>><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?> <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>"><?php echo $_G['forum_thread']['short_subject'];?></a>
</div>
</div>
...
<span class="y pgb"<?php if($_G['setting']['visitedforums']) { ?> id="visitedforums" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'34'})"<?php } ?>><a href="<?php echo $upnavlink;?>">·µ»ØÁĞ±í</a></span>
<?php if($_G['forum']['threadsorts'] && $_G['forum']['threadsorts']['templatelist']) { if(is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $id => $name) { ?><button id="newspecial" class="pn pnc" onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>&extra=<?php echo $extra;?>&sortid=<?php echo $id;?>'"><strong>ÎÒÒª<?php echo $name;?></strong></button>
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><a id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="·¢ĞÂÌû"><img src="<?php echo IMGDIR;?>/pn_post.png" alt="·¢ĞÂÌû" /></a><?php } } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="»Ø¸´"><img src="<?php echo IMGDIR;?>/pn_reply.png" alt="»Ø¸´" /></a>
<?php } ?>
...
<?php if(!$_G['forum']['allowspecialonly']) { ?><li><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>">·¢±íÌû×Ó</a></li><?php } if($_G['forum']['threadsorts'] && !$_G['forum']['allowspecialonly']) { if(is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $id => $threadsorts) { if($_G['forum']['threadsorts']['show'][$id]) { ?>
...
<?php } } } if($_G['group']['allowpostpoll']) { ?><li class="poll"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=1">·¢ÆğÍ¶Æ±</a></li><?php } if($_G['group']['allowpostreward']) { ?><li class="reward"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=3">·¢²¼ĞüÉÍ</a></li><?php } if($_G['group']['allowpostdebate']) { ?><li class="debate"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=5">·¢Æğ±çÂÛ</a></li><?php } if($_G['group']['allowpostactivity']) { ?><li class="activity"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=4">·¢Æğ»î¶¯</a></li><?php } if($_G['group']['allowposttrade']) { ?><li class="trade"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=2">³öÊÛÉÌÆ·</a></li><?php } if($_G['setting']['threadplugins']) { if(is_array($_G['forum']['threadplugin'])) foreach($_G['forum']['threadplugin'] as $tpid) { if(array_key_exists($tpid, $_G['setting']['threadplugins']) && @in_array($tpid, $_G['group']['allowthreadplugin'])) { ?>
...
<div class="f_c">
<div class="c">
<h3>Ñ¡ÖĞ&nbsp;<strong id="mdct" class="xi1"></strong>&nbsp;Æª: </h3>
<?php if($_G['forum']['ismoderator']) { if($_G['group']['allowwarnpost']) { ?><a href="javascript:;" onclick="modaction('warn')">¾¯¸æ</a><span class="pipe">|</span><?php } if($_G['group']['allowbanpost']) { ?><a href="javascript:;" onclick="modaction('banpost')">ÆÁ±Î</a><span class="pipe">|</span><?php } if($_G['group']['allowdelpost'] && !$rushreply) { ?><a href="javascript:;" onclick="modaction('delpost')">É¾³ı</a><span class="pipe">|</span><?php } } if($_G['forum']['ismoderator'] && $_G['group']['allowstickreply'] || $_G['forum_thread']['authorid'] == $_G['uid']) { ?><a href="javascript:;" onclick="modaction('stickreply')">ÖÃ¶¥</a><span class="pipe">|</span><?php } if($_G['forum_thread']['pushedaid'] && $allowpostarticle) { ?><a href="javascript:;" onclick="modaction('pushplus', '', 'aid=<?php echo $_G['forum_thread']['pushedaid'];?>', 'portal.php?mod=portalcp&ac=article&op=pushplus')">ÎÄÕÂÁ¬ÔØ</a><span class="pipe">|</span><?php } ?>
</div>
</div>
</td>
<td class="m_r"></td>
...
<div id="modmenu" class="xi2 pbm"><?php $modopt=0;?><?php if($_G['forum']['ismoderator']) { if($_G['group']['allowdelpost']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(3, 'delete')">É¾³ıÖ÷Ìâ</a><span class="pipe">|</span><?php } if($_G['group']['allowbumpthread'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(3, 'down')">Éı½µ</a><span class="pipe">|</span><?php } if($_G['group']['allowstickthread'] && ($_G['forum_thread']['displayorder'] <= 3 || $_G['adminid'] == 1) && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(1, 'stick')">ÖÃ¶¥</a><span class="pipe">|</span><?php } if($_G['group']['allowhighlightthread'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(1, 'highlight')">¸ßÁÁ</a><span class="pipe">|</span><?php } if($_G['group']['allowdigestthread'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(1, 'digest')">¾«»ª</a><span class="pipe">|</span><?php } if($_G['group']['allowrecommendthread'] && !empty($_G['forum']['modrecommend']['open']) && $_G['forum']['modrecommend']['sort'] != 1 && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(1, 'recommend')">ÍÆ¼ö</a><span class="pipe">|</span><?php } if($_G['group']['allowstampthread'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('stamp')">Í¼ÕÂ</a><span class="pipe">|</span><?php } if($_G['group']['allowstamplist'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('stamplist')">Í¼±ê</a><span class="pipe">|</span><?php } if($_G['group']['allowclosethread'] && !$_G['forum_thread']['is_archived'] && $_G['forum']['status'] != 3) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(4)"><?php if(!$_G['forum_thread']['closed']) { ?>¹Ø±Õ<?php } else { ?>´ò¿ª<?php } ?></a><span class="pipe">|</span><?php } if($_G['group']['allowmovethread'] && !$_G['forum_thread']['is_archived'] && $_G['forum']['status'] != 3) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(2, 'move')">ÒÆ¶¯</a><span class="pipe">|</span><?php } if($_G['group']['allowedittypethread'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(2, 'type')">·ÖÀà</a><span class="pipe">|</span><?php } if(!$_G['forum_thread']['special'] && !$_G['forum_thread']['is_archived']) { if($_G['group']['allowcopythread'] && $_G['forum']['status'] != 3) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('copy')">¸´ÖÆ</a><span class="pipe">|</span><?php } if($_G['group']['allowmergethread'] && $_G['forum']['status'] != 3) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('merge')">ºÏ²¢</a><span class="pipe">|</span><?php } if($_G['group']['allowrefund'] && $_G['forum_thread']['price'] > 0) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('refund')">³·Ïú¸¶·Ñ</a><span class="pipe">|</span><?php } } if($_G['group']['allowsplitthread'] && !$_G['forum_thread']['is_archived'] && $_G['forum']['status'] != 3) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('split')">·Ö¸î</a><span class="pipe">|</span><?php } if($_G['group']['allowrepairthread'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('repair')">ĞŞ¸´</a><span class="pipe">|</span><?php } if($_G['forum_thread']['is_archived'] && $_G['adminid'] == 1) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('restore', '', 'archiveid=<?php echo $_G['forum_thread']['archiveid'];?>')">È¡Ïû´æµµ</a><span class="pipe">|</span><?php } if($_G['forum_firstpid']) { if($_G['group']['allowwarnpost']) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('warn', '<?php echo $_G['forum_firstpid'];?>')">¾¯¸æ</a><span class="pipe">|</span><?php } if($_G['group']['allowbanpost']) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('banpost', '<?php echo $_G['forum_firstpid'];?>')">ÆÁ±Î</a><span class="pipe">|</span><?php } } if($_G['group']['allowremovereward'] && $_G['forum_thread']['special'] == 3 && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modaction('removereward')">ÒÆ³ıĞüÉÍ</a><span class="pipe">|</span><?php } if($_G['forum']['status'] == 3 && in_array($_G['adminid'], array('1','2')) && $_G['forum_thread']['closed'] < 1) { ?><a href="javascript:;" onclick="modthreads(5, 'recommend_group');return false;">ÍÆµ½°æ¿é</a><span class="pipe">|</span><?php } if($_G['group']['allowmanagetag']) { ?><a href="javascript:;" onclick="showWindow('mods', 'forum.php?mod=tag&op=manage&tid=<?php echo $_G['tid'];?>', 'get', 0)">±êÇ©</a><span class="pipe">|</span><?php } if($_G['group']['alloweditusertag']) { ?><a href="javascript:;" onclick="showWindow('usertag', 'forum.php?mod=misc&action=usertag&tid=<?php echo $_G['tid'];?>', 'get', 0)">ÓÃ»§±êÇ©</a><span class="pipe">|</span><?php } } if($allowpusharticle && $allowpostarticle) { ?><?php $modopt++?><a href="portal.php?mod=portalcp&amp;ac=article&amp;from_idtype=tid&amp;from_id=<?php echo $_G['tid'];?>">Éú³ÉÎÄÕÂ</a><span class="pipe">|</span><?php } ?>
...
Â¥Ö÷: <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" title="<?php echo $_G['forum_thread']['author'];?>"><?php echo $_G['forum_thread']['author'];?></a>
<?php } else { ?>
Â¥Ö÷:
<?php if($_G['forum']['ismoderator']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>">ÄäÃû</a>
<?php } else { ?>
ÄäÃû
<?php } } ?>
</div>
<?php } else { ?>
<div class="hm">
<span class="xg1">²é¿´:</span> <span class="xi1"><?php echo $_G['forum_thread']['views'];?></span><span class="pipe">|</span><span class="xg1">»Ø¸´:</span> <span class="xi1"><?php echo $_G['forum_thread']['replies'];?></span>
</div>
<?php } ?>
</td>
...
<?php if(!IS_ROBOT) { ?>
<div class="y">
<?php if($post['invisible'] == 0) { ?><a href="forum.php?mod=viewthread&amp;action=printable&amp;tid=<?php echo $_G['tid'];?>" title="´òÓ¡" target="_blank"><img src="<?php echo IMGDIR;?>/print.png" alt="´òÓ¡" class="vm" /></a>
<?php } ?>
<a href="forum.php?mod=redirect&amp;goto=nextoldset&amp;tid=<?php echo $_G['tid'];?>" title="ÉÏÒ»Ö÷Ìâ"><img src="<?php echo IMGDIR;?>/thread-prev.png" alt="ÉÏÒ»Ö÷Ìâ" class="vm" /></a>
<a href="forum.php?mod=redirect&amp;goto=nextnewset&amp;tid=<?php echo $_G['tid'];?>" title="ÏÂÒ»Ö÷Ìâ"><img src="<?php echo IMGDIR;?>/thread-next.png" alt="ÏÂÒ»Ö÷Ìâ" class="vm" /></a>
</div>
<?php } ?>
<h1 class="ts">
...
<span class="xg1">
<?php if($_G['forum_thread']['displayorder'] == -2) { ?>(ÉóºËÖĞ)
<?php } elseif($_G['forum_thread']['displayorder'] == -3) { ?>(ÒÑºöÂÔ)
<?php } elseif($_G['forum_thread']['displayorder'] == -4) { ?>(²İ¸å)
<?php } if($_G['forum_thread']['recommendlevel']) { ?>
&nbsp;<img src="<?php echo IMGDIR;?>/recommend_<?php echo $_G['forum_thread']['recommendlevel'];?>.gif" alt="" title="ÆÀ¼ÛÖ¸Êı <?php echo $_G['forum_thread']['recommends'];?>" />
<?php } if($_G['forum_thread']['heatlevel']) { ?>
&nbsp;<img src="<?php echo IMGDIR;?>/hot_<?php echo $_G['forum_thread']['heatlevel'];?>.gif" alt="" title="<?php echo $_G['forum_thread']['heatlevel'];?> ¼¶ÈÈÃÅ" />
<?php } if($_G['forum_thread']['closed'] == 1) { ?>
&nbsp;<img src="<?php echo IMGDIR;?>/locked.gif" alt="¹Ø±Õ" title="¹Ø±Õ" class="vm" />
<?php } ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php echo $fromuid;?>" onclick="return copyThreadUrl(this)" <?php if($fromuid) { ?>title="ÄúµÄÅóÓÑ·ÃÎÊ´ËÁ´½Óºó£¬Äú½«»ñµÃÏàÓ¦µÄ»ı·Ö½±Àø"<?php } ?>>[¸´ÖÆÁ´½Ó]</a>
</span>
<!--////////////////////////repush-->
<a href="forum.php?mod=repush&amp;tid=<?php echo $_G['tid'];?>&amp;fid=<?php echo $_G['fid'];?>"><font color='red'>repush</font></a>
...
<tr>
<td class="pls vm ptm">
<img src="<?php echo IMGDIR;?>/thread_prize_s.png" class="hm" alt="»ØÌû½±Àø" />
...
»Ø¸´±¾Ìû¿É»ñµÃ <?php echo $_G['forum_thread']['replycredit_rule']['extcredits'];?> <?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['title'];?>½±Àø! Ã¿ÈËÏŞ <?php echo $_G['forum_thread']['replycredit_rule']['membertimes'];?> ´Î<?php if($_G['forum_thread']['replycredit_rule']['random'] > 0) { ?><span class="xg1">(ÖĞ½±¸ÅÂÊ <?php echo $_G['forum_thread']['replycredit_rule']['random'];?>%)</span><?php } ?>
</td>
</tr>
<?php if($rushreply) { ?>
<tr class="ad">
...
<tr>
<td class="pls vm ptm">
<img src="<?php echo IMGDIR;?>/rushreply_s.png" class="vm" alt="ÇÀÂ¥" />
<strong>ÇÀÂ¥</strong>
</td>
<td class="plc ptm pbm xi1">
<?php if($rushresult['rewardfloor']) { ?>
<span class="y">
<?php if($_G['uid'] == $_G['thread']['authorid'] || $_G['forum']['ismoderator']) { ?><a href="javascript:;" onclick="showWindow('membernum', 'forum.php?mod=ajax&action=get_rushreply_membernum&tid=<?php echo $_G['tid'];?>')" class="y pn xi2"><span>Í³¼Æ²ÎÓëÈËÊı</span></a><?php } if(!$_GET['checkrush']) { ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;checkrush=1" rel="nofollow" class="y pn xi2"><span>²é¿´ÇÀÖĞÂ¥²ã</span></a>
<?php } ?>
</span>
<?php } if($rushresult['creditlimit'] == '') { ?>
±¾ÌûÎªÇÀÂ¥Ìû£¬»¶Ó­ÇÀÂ¥!&nbsp;
<?php } else { ?>
±¾ÌûÎªÇÀÂ¥Ìû£¬<?php echo $rushresult['creditlimit_title'];?>´óÓÚ<?php echo $rushresult['creditlimit'];?>¿ÉÒÔÇÀÂ¥ &nbsp;
<?php } if($rushresult['starttimefrom']) { ?>
 ÇÀÂ¥¿ªÊ¼£º<?php echo $rushresult['starttimefrom'];?>&nbsp;
<?php } if($rushresult['starttimeto']) { ?>
ÇÀÂ¥½áÊø£º<?php echo $rushresult['starttimeto'];?>&nbsp;
<?php } if($rushresult['stopfloor']) { ?>
½ØÖ¹Â¥²ã£º<?php echo $rushresult['stopfloor'];?>&nbsp;
<?php } if($rushresult['rewardfloor']) { ?>
½±ÀøÂ¥²ã: <?php echo $rushresult['rewardfloor'];?>&nbsp;
<?php } if($rushresult['rewardfloor'] && $_GET['checkrush']) { ?>
<p class="ptn">
<?php if($countrushpost) { ?>[<strong><?php echo $countrushpost;?></strong>]¸öÂ¥²ãÒÑÖĞ½±<?php } else { ?> ÔİÊ±»¹Ã»ÓĞÂ¥²ãÖĞ½± <?php } ?>&nbsp;&nbsp;
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>" class="xi2">·µ»ØÇÀÂ¥Ìû</a>
</p>
<?php } ?>
</td>
</tr>
...
<label class="z">µçÌİÖ±´ï</label>

<input type="text" class="px p_fre z" size="2" onkeyup="$('fj_btn').href='forum.php?mod=redirect&ptid=<?php echo $_G['tid'];?>&authorid=<?php echo $_GET['authorid'];?>&postno='+this.value" onkeydown="if(event.keyCode==13) {window.location=$('fj_btn').href;return false;}" title="Ìø×ªµ½Ö¸¶¨Â¥²ã" />

<a href="javascript:;" id="fj_btn" class="z" title="Ìø×ªµ½Ö¸¶¨Â¥²ã"><img src="<?php echo IMGDIR;?>/fj_btn.png" alt="Ìø×ªµ½Ö¸¶¨Â¥²ã" class="vm" /></a>

</div>

<?php } if($post['warned']) { ?>

<a href="forum.php?mod=misc&amp;action=viewwarning&amp;tid=<?php echo $_G['tid'];?>&amp;uid=<?php echo $post['authorid'];?>" title="ÊÜµ½¾¯¸æ" class="y" onclick="showWindow('viewwarning', this.href)"><img src="<?php echo IMGDIR;?>/warning.gif" alt="ÊÜµ½¾¯¸æ" /></a>

<?php } ?>

<strong>

<a href="<?php if($post['first']) { ?>forum.php?mod=viewthread&tid=<?php echo $_G['tid'];?><?php echo $fromuid;?><?php } else { ?>forum.php?mod=redirect&goto=findpost&ptid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?><?php echo $fromuid;?><?php } ?>" title="ÄúµÄÅóÓÑ·ÃÎÊ´ËÁ´½Óºó£¬Äú½«»ñµÃÏàÓ¦µÄ»ı·Ö½±Àø" id="postnum<?php echo $post['pid'];?>" onclick="setCopy(this.href, 'Ìû×ÓµØÖ·¸´ÖÆ³É¹¦');return false;"><?php if(!empty($postno[$post['number']])) { ?><?php echo $postno[$post['number']];?><?php } else { ?><em><?php echo $post['number'];?></em><?php echo $postno['0'];?><?php } ?></a>
...
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;checkrush=1" rel="nofollow" title="²é¿´ÇÀÖĞÂ¥²ã" class="v">¹§Ï²</a>

<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;checkrush=1" rel="nofollow" title="²é¿´ÇÀÖĞÂ¥²ã" class="b">ÇÀÖĞ±¾Â¥</a>
...
<?php if($post['stand'] == 1) { ?><a class="v" href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;filter=debate&amp;stand=1" title="Ö»¿´Õı·½">Õı·½</a>

<?php } elseif($post['stand'] == 2) { ?><a class="v" href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;filter=debate&amp;stand=2" title="Ö»¿´·´·½">·´·½</a>

<?php } else { ?><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;filter=debate&amp;stand=0" title="Ö»¿´ÖĞÁ¢">ÖĞÁ¢</a><?php } if($post['stand']) { ?>

<a class="b" href="forum.php?mod=misc&amp;action=debatevote&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" id="voterdebate_<?php echo $post['pid'];?>" onclick="ajaxmenu(this);doane(event);">Ö§³Ö <?php echo $post['voters'];?></a>
...
<em id="authorposton<?php echo $post['pid'];?>">·¢±íÓÚ <?php echo $post['dateline'];?></em>

<?php if($post['status'] & 8) { ?>

<span class="xg1"><?php if($_G['setting']['mobile']['mobilecomefrom']) { ?><?php echo $_G['setting']['mobile']['mobilecomefrom'];?><?php } else { ?>À´×ÔÊÖ»ú<?php } ?></span>

<?php } if($post['invisible'] == 0) { if(!IS_ROBOT && !$_GET['authorid'] && !$_G['forum_thread']['archiveid']) { ?>

<span class="pipe">|</span><a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>&amp;authorid=<?php echo $post['authorid'];?>" rel="nofollow">Ö»¿´¸Ã×÷Õß</a>

<?php } elseif(!$_G['forum_thread']['archiveid']) { ?>

<span class="pipe">|</span><a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>" rel="nofollow">ÏÔÊ¾È«²¿Â¥²ã</a>
...
<span class="pipe">|</span><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=1">µ¹Ğòä¯ÀÀ</a>

<?php } else { ?>

<span class="pipe">|</span><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=2">ÕıĞòä¯ÀÀ</a>
...
<a id="replynotice" href="forum.php?mod=misc&amp;action=replynotice&amp;op=ignore&amp;tid=<?php echo $_G['tid'];?>" status="1" onclick="ajaxmenu(this, 3000, 0, 0, '43', function () {replyNotice();});return false;">È¡Ïû»Ø¸´Í¨Öª</a>

<?php } else { ?>

<a id="replynotice" href="forum.php?mod=misc&amp;action=replynotice&amp;op=receive&amp;tid=<?php echo $_G['tid'];?>" status="0" onclick="ajaxmenu(this, 3000, 0, 0, '43', function () {replyNotice();});return false;">½ÓÊÕ»Ø¸´Í¨Öª</a>
...
»ØÌû½±Àø <span class="xw1 xs2 xi1">+<?php echo $post['replycredit'];?></span> <?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['title'];?>
...
<div class="locked">ÌáÊ¾: <em>×÷Õß±»½ûÖ¹»òÉ¾³ı ÄÚÈİ×Ô¶¯ÆÁ±Î</em></div>
<?php } elseif(!$_G['forum']['ismoderator'] && $post['status'] & 1) { ?>
<div class="locked">ÌáÊ¾: <em>¸ÃÌû±»¹ÜÀíÔ±»ò°æÖ÷ÆÁ±Î</em></div>
<?php } elseif($needhiddenreply) { ?>
<div class="locked">´ËÌû½ö×÷Õß¿É¼û</div>
...
<div class="locked">ÌáÊ¾: <em>×÷Õß±»½ûÖ¹»òÉ¾³ı ÄÚÈİ×Ô¶¯ÆÁ±Î£¬Ö»ÓĞ¹ÜÀíÔ±»òÓĞ¹ÜÀíÈ¨ÏŞµÄ³ÉÔ±¿É¼û</em></div>
<?php } elseif($post['status'] & 1) { ?>
<div class="locked">ÌáÊ¾: <em>¸ÃÌû±»¹ÜÀíÔ±»ò°æÖ÷ÆÁ±Î£¬Ö»ÓĞ¹ÜÀíÔ±»òÓĞ¹ÜÀíÈ¨ÏŞµÄ³ÉÔ±¿É¼û</em></div>
...
<div class="locked"><em class="y"><a href="forum.php?mod=misc&amp;action=viewpayments&amp;tid=<?php echo $_G['tid'];?>" onclick="showWindow('pay', this.href)">¼ÇÂ¼</a></em>¸¶·ÑÖ÷Ìâ, ¼Û¸ñ: <strong><?php echo $_G['forum_thread']['price'];?> <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title'];?> </strong></div>
...
¸ÃĞÅÏ¢ÒÑ¾­¹ıÆÚ
<?php } else { ?>
<table summary="·ÖÀàĞÅÏ¢" cellpadding="0" cellspacing="0" class="cgtl mbm">
...
<?php if(!$_G['inajax']) { if($ad_a_pr) { ?>
<?php echo $ad_a_pr;?>
<?php } } if($post['invisible'] != '-2' || $_G['forum']['ismoderator']) { ?><?php echo $post['message'];?><?php } else { ?><span class="xg1">´ıÉóºË</span><?php } ?></td></tr></table>
<?php } if($post['attachment']) { ?>
<div class="attach_nopermission">
<div>
<h3>±¾Ìû×ÓÖĞ°üº¬¸ü¶à×ÊÔ´</h3>
<p><?php if($_G['uid']) { ?>ÄúËùÔÚµÄÓÃ»§×éÎŞ·¨ÏÂÔØ»ò²é¿´¸½¼ş<?php } elseif($_G['connectguest']) { ?>ÄúĞèÒª <a href="member.php?mod=connect" class="xi2">ÍêÉÆÕÊºÅĞÅÏ¢</a> »ò <a href="member.php?mod=connect&amp;ac=bind" class="xi2">°ó¶¨ÒÑÓĞÕÊºÅ</a> ºó²Å¿ÉÒÔÏÂÔØ»ò²é¿´<?php } else { ?>ÄúĞèÒª <a href="member.php?mod=logging&amp;action=login" onclick="showWindow('login', this.href);return false;">µÇÂ¼</a> ²Å¿ÉÒÔÏÂÔØ»ò²é¿´£¬Ã»ÓĞÕÊºÅ£¿<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" title="×¢²áÕÊºÅ"><?php echo $_G['setting']['reglinkname'];?></a> <?php if(!empty($_G['setting']['pluginhooks']['global_login_text'])) echo $_G['setting']['pluginhooks']['global_login_text'];?><?php } ?></p>
</div>
</div>
...
<strong>¸ü¶àÍ¼Æ¬</strong>
<a href="javascript:;" onclick="attachimglst('<?php echo $post['pid'];?>', 0)" class="xi2 attl_g">Ğ¡Í¼</a>
<a href="javascript:;" onclick="attachimglst('<?php echo $post['pid'];?>', 1, <?php echo intval($_G['setting']['lazyload']); ?>)" class="xi2 attl_m">´óÍ¼</a>
</div>
<div id="imagelist_<?php echo $post['pid'];?>" class="cl" style="display:none"><?php echo showattach($post, 1); ?></div>
<div id="imagelistthumb_<?php echo $post['pid'];?>" class="pattl_c cl"><img src="<?php echo IMGDIR;?>/loading.gif" width="16" height="16" class="vm" /> ×éÍ¼´ò¿ªÖĞ£¬ÇëÉÔºò......</div>
...
<div>
<h3 class="psth xs1">»ØÌûÍÆ¼ö</h3><?php if(is_array($sticklist)) foreach($sticklist as $rpost) { ?><div class="pstl xs1">
...
<div class="psti">
<p>
<a href="home.php?mod=space&amp;uid=<?php echo $rpost['authorid'];?>" class="xi2 xw1"><?php echo $rpost['author'];?></a> <a href="javascript:;" onclick="window.open('forum.php?mod=redirect&goto=findpost&ptid=<?php echo $rpost['tid'];?>&pid=<?php echo $rpost['pid'];?>')" class="xi2">²é¿´Â¥²ã</a>
<?php if($_G['group']['allowstickreply'] || $_G['forum_thread']['authorid'] == $_G['uid']) { ?>&nbsp;<a href="javascript:;" onclick="modaction('stickreply', <?php echo $rpost['pid'];?>, '&undo=yes')" class="xi2">½â³ıÖÃ¶¥</a><?php } ?>
</p>
...
<?php echo $rpost['author'];?> <em>¸ÃÓÃ»§ÒÑ±»É¾³ı</em>
<?php } ?>
 <a href="javascript:;" onclick="window.open('forum.php?mod=redirect&goto=findpost&ptid=<?php echo $rpost['tid'];?>&pid=<?php echo $rpost['pid'];?>')" class="xi2">²é¿´Â¥²ã</a>
 <?php if($_G['group']['allowstickreply'] || $_G['forum_thread']['authorid'] == $_G['uid']) { ?>&nbsp;<a href="javascript:;" onclick="modaction('stickreply', <?php echo $rpost['pid'];?>, '&undo=yes')" class="xi2">½â³ıÖÃ¶¥</a><?php } ?>
</p>
<div class="mtn"><?php echo $rpost['message'];?></div>
</div>
...
<?php if($comment['rpid']) { ?>
<a href="forum.php?mod=redirect&amp;goto=findpost&amp;pid=<?php echo $comment['rpid'];?>&amp;ptid=<?php echo $_G['tid'];?>" class="xi2">ÏêÇé</a>
<a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;repquote=<?php echo $comment['rpid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_GET['from']) { ?>&amp;from=<?php echo $_GET['from'];?><?php } ?>" class="xi2" onclick="showWindow('reply', this.href)">»Ø¸´</a>
<?php } ?>
<span class="xg1">
·¢±íÓÚ <?php echo dgmdate($comment[dateline], 'u');?><?php if($comment['useip'] && $_G['group']['allowviewip']) { ?>&nbsp;IP:<?php echo $comment['useip'];?><?php } if($_G['forum']['ismoderator'] && $_G['group']['allowdelpost']) { ?>&nbsp;<a href="javascript:;" onclick="modaction('delcomment', <?php echo $comment['id'];?>)">É¾³ı</a><?php } ?>
</span>
</div>
</div>
<?php } if($commentcount[$post['pid']] > $_G['setting']['commentnumber']) { ?><div class="pgs mbm cl"><div class="pg"><a href="javascript:;" class="nxt" onclick="ajaxget('forum.php?mod=misc&action=commentmore&tid=<?php echo $post['tid'];?>&pid=<?php echo $post['pid'];?>&page=2', 'comment_<?php echo $post['pid'];?>')">ÏÂÒ»Ò³</a></div></div><?php } } ?>
</div>
...
<strong><a href="forum.php?mod=misc&amp;action=viewratings&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="ÒÑÓĞ<?php echo count($postlist[$post['pid']]['totalrate']);; ?>ÈËÆÀ·Ö, ²é¿´È«²¿ÆÀ·Ö"><?php echo count($postlist[$post['pid']]['totalrate']);; ?></a></strong>
<p><a href="forum.php?mod=misc&amp;action=viewratings&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)">²é¿´È«²¿ÆÀ·Ö</a></p>
<?php } ?>
</dt>
<dd>
<?php } ?>
...
<table class="ratl">
<tr>
<th class="xw1" width="120"><a href="forum.php?mod=misc&amp;action=viewratings&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="²é¿´È«²¿ÆÀ·Ö">ÒÑÓĞ <span class="xi1"><?php echo count($postlist[$post['pid']]['totalrate']);; ?></span> ÈËÆÀ·Ö</a></th><?php if(is_array($post['ratelogextcredits'])) foreach($post['ratelogextcredits'] as $id => $score) { ?><th width="50"><i><?php echo $_G['setting']['extcredits'][$id]['title'];?></i></th>
<?php } ?>
<th>
<a href="javascript:;" onclick="toggleRatelogCollapse('ratelog_<?php echo $post['pid'];?>', this);" class="y xi2 op"><?php if(!empty($_G['cookie']['ratecollapse'])) { ?>Õ¹¿ª<?php } else { ?>ÊÕÆğ<?php } ?></a>
<i>ÀíÓÉ</i>
</th>
</tr>
...
<p class="ratc">
×ÜÆÀ·Ö:&nbsp;<?php if(is_array($post['ratelogextcredits'])) foreach($post['ratelogextcredits'] as $id => $score) { if($score > 0) { ?>
...
<?php } } ?>
&nbsp;<a href="forum.php?mod=misc&amp;action=viewratings&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="²é¿´È«²¿ÆÀ·Ö" class="xi2">²é¿´È«²¿ÆÀ·Ö</a>
</p>
<?php } else { ?>
...
<h3 class="psth xs1">±¾Ìû±»ÒÔÏÂÌÔ×¨¼­ÍÆ¼ö:</h3>

<ul class="mbw xl xl2 cl"><?php if(is_array($post['relatecollection'])) foreach($post['relatecollection'] as $var) { ?><li>&middot; <a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $var['ctid'];?>" title="<?php echo $var['name'];?>" target="_blank" class="xi2 xw1"><?php echo $var['name'];?></a><span class="pipe">|</span><span class="xg1">Ö÷Ìâ: <?php echo $var['threadnum'];?>, ¶©ÔÄ: <?php echo $var['follownum'];?></span></li>

<?php } if($post['releatcollectionmore']) { ?>

<li>&middot; <a href="forum.php?mod=collection&amp;tid=<?php echo $_G['tid'];?>" target="_blank" class="xi2 xw1">¸ü¶à</a></li>
...
ÄúÊÇ´ÓÌÔ×¨¼­ <a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $post['sourcecollection']['ctid'];?>" target="_blank" class="xi2"><?php echo $post['sourcecollection']['name'];?></a> ·ÃÎÊµ½±¾ÌûµÄ£¬»¶Ó­¶Ô×¨¼­´ò·Ö£º
...
&nbsp;<button type="submit" value="submit" class="pn"><span>ÆÀ·Ö</span></button>
...
<th><p><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>&amp;do=thread&amp;view=me&amp;from=space" class="xi2"><?php echo dnumber($post['threads']); ?></a></p>Ö÷Ìâ</th>

<th>

<?php if(helper_access::check_module('follow')) { ?>

<p><a href="home.php?mod=follow&amp;do=follower&amp;uid=<?php echo $post['authorid'];?>" class="xi2"><?php echo dnumber($post['follower']); ?></a></p>ÌıÖÚ

<?php } else { ?>

<p><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>&amp;do=friend&amp;view=me" class="xi2"><?php echo dnumber($post['friends']); ?></a></p>ºÃÓÑ

<?php } ?>

</th>

<td><p><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>&amp;do=profile" class="xi2"><?php echo dnumber($post['credits']); ?></a></p>»ı·Ö</td>
...
<div class="tip_c"><?php echo $post['authortitle'];?>, »ı·Ö <?php echo $post['credits'];?>, ¾àÀëÏÂÒ»¼¶»¹Ğè <?php echo $post['upgradecredit'];?> »ı·Ö</div>
...
<a href="home.php?mod=spacecp&amp;ac=follow&amp;op=add&amp;hash=<?php echo FORMHASH;?>&amp;fuid=<?php echo $post['authorid'];?>" id="followmod_<?php echo $post['authorid'];?>" title="ÊÕÌıTA" class="xi2" onclick="showWindow('followmod', this.href, 'get', 0);">ÊÕÌıTA</a>

</li>

<?php } ?>

<li class="pm2"><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $post['authorid'];?>&amp;touid=<?php echo $post['authorid'];?>&amp;pmid=0&amp;daterange=2&amp;pid=<?php echo $post['pid'];?>&amp;tid=<?php echo $post['tid'];?>" onclick="showWindow('sendpm', this.href);" title="·¢ÏûÏ¢" class="xi2">·¢ÏûÏ¢</a></li>
...
<?php echo $post['author'];?> <em>¸ÃÓÃ»§ÒÑ±»É¾³ı</em>
...
<a href="<?php if($_G['adminid'] == 1) { ?>admin.php?frames=yes&action=members&operation=search&uid=<?php echo $post['authorid'];?>&submit=yes<?php } else { ?>forum.php?mod=modcp&action=member&op=edit&uid=<?php echo $post['authorid'];?><?php } ?>" target="_blank">±à¼­</a>

<?php } if($_G['group']['allowbanuser']) { if($_G['adminid'] == 1) { ?>

<a href="admin.php?action=members&amp;operation=ban&amp;username=<?php echo $post['usernameenc'];?>&amp;frames=yes" target="_blank">½ûÖ¹</a>

<?php } else { ?>

<a href="forum.php?mod=modcp&amp;action=member&amp;op=ban&amp;uid=<?php echo $post['authorid'];?>" target="_blank">½ûÖ¹</a>

<?php } } ?>

<a href="forum.php?mod=modcp&amp;action=thread&amp;op=post&amp;do=search&amp;searchsubmit=1&amp;users=<?php echo $post['usernameenc'];?>" target="_blank">Ìû×Ó</a>

<?php if($_G['adminid'] == 1) { ?>

<a href="forum.php?mod=ajax&amp;action=quickclear&amp;uid=<?php echo $post['authorid'];?>" onclick="showWindow('qclear_<?php echo $post['authorid'];?>', this.href, 'get', 0)">ÇåÀí</a>
...
<?php } if(!IS_ROBOT && $post['first'] && !$_G['forum_thread']['archiveid']) { if(!empty($lastmod['modaction'])) { ?><div class="modact"><a href="forum.php?mod=misc&amp;action=viewthreadmod&amp;tid=<?php echo $_G['tid'];?>" title="Ìû×ÓÄ£Ê½" onclick="showWindow('viewthreadmod', this.href)"><?php if($lastmod['modactiontype'] == 'REB') { ?>±¾Ö÷ÌâÓÉ <?php echo $lastmod['modusername'];?> ÓÚ <?php echo $lastmod['moddateline'];?> <?php echo $lastmod['modaction'];?>µ½ <?php echo $lastmod['reason'];?><?php } else { ?>±¾Ö÷ÌâÓÉ <?php echo $lastmod['modusername'];?> ÓÚ <?php echo $lastmod['moddateline'];?> <?php echo $lastmod['modaction'];?><?php } ?></a></div><?php } ?>
...
<a href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" id="k_relay" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('relaynumber').innerHTML + ' ÈË×ª²¥'"><i><img src="<?php echo IMGDIR;?>/rt.png" alt="×ª²¥" />×ª²¥<span id="relaynumber"><?php echo $_G['forum_thread']['relay'];?></span></i></a>

<?php } if(!$_G['forum']['disablecollect'] && helper_access::check_module('collection')) { ?>

<a href="forum.php?mod=collection&amp;action=edit&amp;op=addthread&amp;tid=<?php echo $_G['tid'];?>" id="k_collect" onclick="showWindow(this.id, this.href);return false;" onmouseover="this.title = $('collectionnumber').innerHTML + ' ÈËÌÔÌû'"><i><img src="<?php echo IMGDIR;?>/collection.png" alt="·ÖÏí" />ÌÔÌû<span id="collectionnumber"><?php echo $post['releatcollectionnum'];?></span></i></a>

<?php } if(helper_access::check_module('share')) { ?>

<a href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" id="k_share" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('sharenumber').innerHTML + ' ÈË·ÖÏí'"><i><img src="<?php echo IMGDIR;?>/oshr.png" alt="·ÖÏí" />·ÖÏí<span id="sharenumber"><?php echo $_G['forum_thread']['sharetimes'];?></span></i></a>

<?php } ?>

<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' ÈËÊÕ²Ø'"><i><img src="<?php echo IMGDIR;?>/fav.gif" alt="ÊÕ²Ø" />ÊÕ²Ø<span id="favoritenumber"><?php echo $_G['forum_thread']['favtimes'];?></span></i></a>

<?php if(($_G['group']['allowrecommend'] || !$_G['uid']) && $_G['setting']['recommendthread']['status']) { if(!empty($_G['setting']['recommendthread']['addtext'])) { ?>

<a id="recommend_add" href="forum.php?mod=misc&amp;action=recommend&amp;do=add&amp;tid=<?php echo $_G['tid'];?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_add').innerHTML + ' ÈË<?php echo $_G['setting']['recommendthread']['addtext'];?>'"><i><img src="<?php echo IMGDIR;?>/rec_add.gif" alt="<?php echo $_G['setting']['recommendthread']['addtext'];?>" /><?php echo $_G['setting']['recommendthread']['addtext'];?><span id="recommendv_add"><?php echo $_G['forum_thread']['recommend_add'];?></span></i></a>

<?php } if(!empty($_G['setting']['recommendthread']['subtracttext'])) { ?>

<a id="recommend_subtract" href="forum.php?mod=misc&amp;action=recommend&amp;do=subtract&amp;tid=<?php echo $_G['tid'];?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(-<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_subtract').innerHTML + ' ÈË<?php echo $_G['setting']['recommendthread']['subtracttext'];?>'"><i><img src="<?php echo IMGDIR;?>/rec_subtract.gif" alt="<?php echo $_G['setting']['recommendthread']['subtracttext'];?>" /><?php echo $_G['setting']['recommendthread']['subtracttext'];?><span id="recommendv_subtract"><?php echo $_G['forum_thread']['recommend_sub'];?></span></i></a>

<?php } } if($_G['group']['raterange'] && $post['authorid']) { ?>

<a href="javascript:;" id="ak_rate" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;" title="<?php echo count($postlist[$post['pid']]['totalrate']);; ?> ÈËÆÀ·Ö"><i><img src="<?php echo IMGDIR;?>/agree.gif" alt="ÆÀ·Ö" />ÆÀ·Ö</i></a>
...
<h3 class="pbm mbm bbda">Ïà¹ØÌû×Ó</h3>
...
<?php if($post['invisible'] == 0) { if($allowpostreply && $post['allowcomment'] && (!$thread['closed'] || $_G['forum']['ismoderator'])) { ?><a class="cmmnt" href="forum.php?mod=misc&amp;action=comment&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_G['forum_thread']['special'] == 127) { ?>&amp;special=<?php echo $specialextra;?><?php } ?>" onclick="showWindow('comment', this.href, 'get', 0)">µãÆÀ</a><?php } if((!$_G['uid'] || $allowpostreply) && !$needhiddenreply) { if($post['first']) { ?>

<a class="fastre" href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;reppost=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)">»Ø¸´</a>

<?php } else { ?>

<a class="fastre" href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;repquote=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)">»Ø¸´</a>
...
<a class="editp" href="forum.php?mod=post&amp;action=edit&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?><?php if(!empty($_GET['modthreadkey'])) { ?>&amp;modthreadkey=<?php echo $_GET['modthreadkey'];?><?php } ?>&amp;page=<?php echo $page;?>"><?php if($_G['forum_thread']['special'] == 2 && !$post['message']) { ?>Ìí¼Ó¹ñÌ¨½éÉÜ<?php } else { ?>±à¼­</a><?php } } elseif($_G['uid'] && $post['authorid'] == $_G['uid'] && $_G['setting']['postappend']) { ?>

<a class="appendp" href="forum.php?mod=misc&amp;action=postappend&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onClick="showWindow('postappend', this.href, 'get', 0)">²¹³ä</a>

<?php } if($post['first'] && $post['invisible'] == -3) { ?>

<a class="psave" href="forum.php?mod=misc&amp;action=pubsave&amp;tid=<?php echo $_G['tid'];?>">·¢±í</a>

<?php } if($post['invisible'] == -2 && !$post['first']) { ?>

<span class="xg1">(´ıÉóºË)</span>

<?php } if($post['first'] && $allowblockrecommend) { ?><a class="push" href="javascript:;" onclick="modaction('recommend', '<?php echo $_G['forum_firstpid'];?>', 'op=recommend&idtype=<?php if($_G['forum_thread']['isgroup']) { ?>gtid<?php } else { ?>tid<?php } ?>&id=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'portal.php?mod=portalcp&ac=portalblock')">ÍÆËÍ</a><?php } ?>
...
<a href="javascript:;" id="mgc_post_<?php echo $post['pid'];?>" onmouseover="showMenu(this.id)" class="showmenu">Ê¹ÓÃµÀ¾ß</a>
...
<a href="javascript:;" onclick="setanswer(<?php echo $post['pid'];?>, '<?php echo $_GET['from'];?>')">×î¼Ñ´ğ°¸</a>

<?php } if(!$post['first'] && $_G['group']['raterange'] && $post['authorid']) { ?>

<a href="javascript:;" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;">ÆÀ·Ö</a>

<?php } if(!empty($postlist[$post['pid']]['totalrate']) && $_G['forum']['ismoderator']) { ?>

<a href="forum.php?mod=misc&amp;action=removerate&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('rate', this.href, 'get', -1)">³·ÏúÆÀ·Ö</a>

<?php } if($post['authorid'] != $_G['uid']) { ?>

<a href="javascript:;" onclick="showWindow('miscreport<?php echo $post['pid'];?>', 'misc.php?mod=report&rtype=post&rid=<?php echo $post['pid'];?>&tid=<?php echo $_G['tid'];?>&fid=<?php echo $_G['fid'];?>', 'get', -1);return false;">¾Ù±¨</a>
...
<li style="display:inline;margin-left:12px"><strong class="bw0 bg0_all">°´Á¢³¡É¸Ñ¡: </strong></li>

<li<?php if(!isset($_GET['stand'])) { ?> class="xw1 a"<?php } ?>><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>" hidefocus="true">È«²¿</a></li>

<li<?php if($_GET['stand'] == 1) { ?> class="xw1 a"<?php } ?>><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;stand=1" hidefocus="true">Õı·½</a></li>
...
<li<?php if(isset($_GET['stand']) && $_GET['stand'] == 0) { ?> class="xw1 a"<?php } ?>><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;stand=0" hidefocus="true">ÖĞÁ¢</a></li>
...
<div class="pct">ÎŞĞ§Â¥²ã£¬¸ÃÌûÒÑ¾­±»É¾³ı</div>
...
<!--///////////////////-->
<?php if($_G['thread']['pushstate']==2) { ?>
<div name="follow_thread"><?php $followed=false?><!--////////////////////-->
feedbackers:<?php if(is_array($followlist)) foreach($followlist as $follower) { if($follower['followerid']==$_G['member']['uid']) { ?><?php $followed=true?><a href="home.php?mod=space&amp;uid=<?php echo $follower['followerid'];?>"><font color=red size='3px'><?php echo $follower['follower'];?></font></a>
<?php } else { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $follower['followerid'];?>"><font color='green' size='2px'><?php echo $follower['follower'];?></font></a>
<?php } } ?>
<br/>
<?php if($followed) { ?>
<a href="forum.php?mod=unfollowthread&amp;tid=<?php echo $_G['tid'];?>">click here to unfollow this thread</a>
<?php } else { ?>
<a href="forum.php?mod=followthread&amp;tid=<?php echo $_G['tid'];?>">click here to follow this thread</a>
<?php } ?>
</div>
<?php } ?>
<div style="width:99%;opacity:1;background:url(<?php echo IMGDIR;?>/erweima.jpg);padding:3px;border:solid white 3px ;boader-color:#707070;">
<!--//////////////////////äºŒç»´ç --><?php $mydata=urlencode("http://219.223.222.232/bbs/forum.php?mod=viewthread&amp;tid=$_G[tid]")?><p style="font-family:verdana;font-size:80%;color:black">
<br/>
</p>
<center>
<img style="opacity:0.8" src="http://chart.apis.google.com/chart?chs=150x150&amp;cht=qr&amp;chld=L|0&amp;chl=<?php echo $mydata;?>" width="150" height="150"/>
<a target="__blank" href="http://chart.apis.google.com/chart?chs=150x150&amp;cht=qr&amp;chld=L|0&amp;chl=<?php echo $mydata;?>"><i><font color='white' size='1'>this is two dimension code for pkusz bbs, made by google</font></i></a><br/>
</center>
<p align='right' style="font-family:verdana;font-size:80%;">
<a target="__blank" href='http://www.baike.com/wiki/%E4%BA%8C%E7%BB%B4%E7%A0%81'><font color='black'><i>QA:what is two-dimension-code ?</i></font></a>
</p>
</div>
...
<?php echo $multipage;?>
<span class="pgb y"<?php if($_G['setting']['visitedforums']) { ?> id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"<?php } ?>><a href="<?php echo $upnavlink;?>">·µ»ØÁĞ±í</a></span>
<?php if(!$_G['forum_thread']['is_archived']) { ?>
<a id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="·¢ĞÂÌû"><img src="<?php echo IMGDIR;?>/pn_post.png" alt="·¢ĞÂÌû" /></a>
<?php } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_replytmp" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="»Ø¸´"><img src="<?php echo IMGDIR;?>/pn_reply.png" alt="»Ø¸´" /></a>
<?php } ?>
</div>
...
<a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['from']) { ?>&amp;from=<?php echo $_GET['from'];?><?php } ?>" onclick="return switchAdvanceMode(this.href)">¸ß¼¶Ä£Ê½</a>
...
<a href="javascript:;" title="ÎÄ×Ö¼Ó´Ö" class="fbld"<?php if(empty($seditor['2'])) { ?> onclick="seditor_insertunit('<?php echo $seditor['0'];?>', '[b]', '[/b]');doane(event);"<?php } ?>>B</a>
<?php } if(in_array('color', $seditor['1'])) { ?>
<a href="javascript:;" title="ÉèÖÃÎÄ×ÖÑÕÉ«" class="fclr" id="<?php echo $seditor['0'];?>forecolor"<?php if(empty($seditor['2'])) { ?> onclick="showColorBox(this.id, 2, '<?php echo $seditor['0'];?>');doane(event);"<?php } ?>>Color</a>
<?php } if(in_array('img', $seditor['1'])) { ?>
<a id="<?php echo $seditor['0'];?>img" href="javascript:;" title="Í¼Æ¬" class="fmg"<?php if(empty($seditor['2'])) { ?> onclick="seditor_menu('<?php echo $seditor['0'];?>', 'img');doane(event);"<?php } ?>>Image</a>
<?php } if(in_array('link', $seditor['1'])) { ?>
<a id="<?php echo $seditor['0'];?>url" href="javascript:;" title="Ìí¼ÓÁ´½Ó" class="flnk"<?php if(empty($seditor['2'])) { ?> onclick="seditor_menu('<?php echo $seditor['0'];?>', 'url');doane(event);"<?php } ?>>Link</a>
<?php } if(in_array('quote', $seditor['1'])) { ?>
<a id="<?php echo $seditor['0'];?>quote" href="javascript:;" title="ÒıÓÃ" class="fqt"<?php if(empty($seditor['2'])) { ?> onclick="seditor_menu('<?php echo $seditor['0'];?>', 'quote');doane(event);"<?php } ?>>Quote</a>
<?php } if(in_array('code', $seditor['1'])) { ?>
<a id="<?php echo $seditor['0'];?>code" href="javascript:;" title="´úÂë" class="fcd"<?php if(empty($seditor['2'])) { ?> onclick="seditor_menu('<?php echo $seditor['0'];?>', 'code');doane(event);"<?php } ?>>Code</a>
...
<a id="<?php echo $seditor['0'];?>at" href="javascript:;" title="@ÅóÓÑ" class="fat"<?php if(empty($seditor['2'])) { ?> onclick="seditor_menu('<?php echo $seditor['0'];?>', 'at');doane(event);"<?php } ?>>@ÅóÓÑ</a>
<?php } ?>
<?php echo $seditor['3'];?>
</div></div>
<div class="area">
...
ÄúĞèÒªµÇÂ¼ºó²Å¿ÉÒÔ»ØÌû <a href="member.php?mod=logging&amp;action=login" onclick="showWindow('login', this.href)" class="xi2">µÇÂ¼</a> | <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2"><?php echo $_G['setting']['reglinkname'];?></a>
<?php } else { ?>
ÄúĞèÒª <a href="member.php?mod=connect" class="xi2">ÍêÉÆÕÊºÅĞÅÏ¢</a> »ò <a href="member.php?mod=connect&amp;ac=bind" class="xi2">°ó¶¨ÒÑÓĞÕÊºÅ</a> ºó²Å¿ÉÒÔ·¢Ìû
<?php } } else { ?>
ÄúÏÖÔÚÎŞÈ¨·¢Ìû¡£<a href="javascript:;" onclick="$('fastpostform').submit()" class="xi2">µã»÷²é¿´Ô­Òò</a>
<?php } ?>
...
<tr>
<td>µã»÷¸½¼şÎÄ¼şÃûÌí¼Óµ½Ìû×ÓÄÚÈİÖĞ</td>
<td class="atds">ÃèÊö</td>
<?php if($_G['group']['allowsetattachperm']) { ?>
<td class="attv">
ÔÄ¶ÁÈ¨ÏŞ
<img src="<?php echo IMGDIR;?>/faq.gif" alt="Tip" class="vm" onmouseover="showTip(this)" tip="ÔÄ¶ÁÈ¨ÏŞ°´ÓÉ¸ßµ½µÍÅÅÁĞ£¬¸ßÓÚ»òµÈÓÚÑ¡ÖĞ×éµÄÓÃ»§²Å¿ÉÒÔÔÄ¶Á" />
</td>
...
<p class="ptm pnpost">
<button <?php if($allowpostreply) { ?>type="submit" <?php } elseif(!$_G['uid']) { ?>type="button" onclick="showWindow('login', 'member.php?mod=logging&action=login&guestmessage=yes')" <?php } ?>name="replysubmit" id="fastpostsubmit" class="pn pnc vm" value="replysubmit" tabindex="5"><strong>·¢±í»Ø¸´</strong></button>
...
<?php if(helper_access::check_module('follow')) { ?>
<label class="lb"><input type="checkbox" name="adddynamic" class="pc" value="1" />»ØÌû²¢×ª²¥</label>
<?php } if($_GET['ordertype'] != 1 && empty($_GET['from'])) { ?>
<label for="fastpostrefresh"><input id="fastpostrefresh" type="checkbox" class="pc" />»ØÌûºóÌø×ªµ½×îºóÒ»Ò³</label>
...
<tr>
<td id="v_forums">
<h3 class="mbn pbn bbda xg1">ä¯ÀÀ¹ıµÄ°æ¿é</h3>
<ul class="xl xl1">
...
menudiv.innerHTML = '<div class="tip_c xs0"><a onclick="showWindow(\'setcover_'+newimgid+'\', this.href)" href="forum.php?mod=ajax&amp;action=setthreadcover&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $_G['forum_firstpid'];?>&amp;fid=<?php echo $_G['fid'];?>&amp;imgurl='+imgsrc+'">ÉèÎª·âÃæ</a></div>';
obj.id = newimgid;
