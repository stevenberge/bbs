...
0
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/daren2_123/common/header.htm', 1371452255, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', './template/daren2_123', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1371452255, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', './template/daren2_123', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1371452255, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', './template/daren2_123', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_list.htm', 1371452255, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', './template/daren2_123', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1371452255, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', './template/daren2_123', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/common/footer.htm', 1371452255, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', './template/daren2_123', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/common/header_common.htm', 1371452255, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', './template/daren2_123', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1371452255, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', './template/daren2_123', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1371452255, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', './template/daren2_123', 'forum/forumdisplay')
;?>
...
<?php } ?>
<div id="wp" class="wp"  style="border: 3px solid #909498;padding:10px;background:#f0f0f0;margin-top:10px;"><?php echo adshow("subnavbanner/a_mu");?><?php if($_G['forum']['ismoderator']) { ?>
...
<!--		////from here to demonstrate every post thread --><?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { if($_G['setting']['forumseparator'] == 1 && $separatepos == $key + 1) { ?>
...
<!--//////////-->
<td class="icn">
<?php if($thread['pushstate']==0 ) { ?>
<img src="static/image/normal.png"/>
<?php } elseif($thread['pushstate']==1 ) { ?>
<img src="static/image/pushfail.png"/>
<?php } elseif($thread['pushstate']==2 ) { ?>
<img src="static/image/pushed.png"/>
<?php } ?>
