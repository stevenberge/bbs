...
0
|| checktplrefresh('./template/daren2_123/common/header.htm', './template/default/common/header_common.htm', 1371485334, '5', './data/template/7_5_common_header_forum_repush.tpl.php', './template/daren2_123', 'common/header_forum_repush')
;?>
...
<?php } ?>
<div id="wp" class="wp"  style="border: 3px solid #909498;padding:10px;background:#f0f0f0;margin-top:10px;"><?php echo adshow("subnavbanner/a_mu");?>